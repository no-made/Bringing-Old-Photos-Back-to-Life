...
class TestOptions(BaseOptions):
    def __init__(self):
        ...
        self.onnx = None
        self.start_epoch = -1
        self.test_dataset = "Real_RGB_old.bigfile"
        self.no_degradation = False
        self.no_load_VAE = False
        self.no_lsgan = False
        self.use_v2_degradation = False
        self.use_vae_which_epoch = "latest"
        self.isTrain = False
        self.generate_pair = False
        self.multi_scale_test = 0.5
        self.multi_scale_threshold = 0.5
        self.mask_need_scale = False
        self.scale_num = 1
        self.save_feature_url = ""
        self.test_input = ""
        self.test_mask = ""
        self.test_gt = ""
        self.scale_input = False
        self.save_feature_name = "features.json"
        self.test_rgb_old_wo_scratch = False
        self.test_mode = "Crop"
    ...
    # def initialize(self):
    #     super().initialize()
    #     # No need to redefine the parser here
    #     pass
# class TestOptions(BaseOptions):
#     def initialize(self):
