...
def blur_blending_cv2(im1, im2, mask):
    ...
    mask_blur = mask_blur.astype(np.float32) / 255.0  # Explicitly convert to float32
...
def align_warp_back_multiple(origin_url, replace_url, save_url):
    ...
    for x in os.listdir(origin_url):
        ...
        for face_id in range(len(faces)):
            ...
            print('backward_mask', backward_mask.shape, backward_mask.dtype, backward_mask.max(), backward_mask.min())
